...
mode, duration policy, timestamp support, concurrency, and language count before
recording, then labels each selected track and renders simultaneous results side by side.
